...
Use seperate slides for this?

Step 1: each of you take 2 plastic eggs... step 2: in either excel, googdle sheets, losselear paper, etc. record the information you have in each egg. you get to choose how you record and what info you record, but don't show anyone else! step 3: then, dispose of the data (i.e. either eat the candy or put it back in egg)

Step 4: XXXX

step 5: now, imagine you want to share your data. partner up withsome and make another spreadsheet pooling your data...i.e. include as much data from both your spreadsheets as you can. did both of you include the same data? if not, how can you best pool your data

step 6: compare orignals to the joint datasets ##Video on the problems of big data:
