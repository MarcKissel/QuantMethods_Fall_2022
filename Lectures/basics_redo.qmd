...
If you want to make a series of numbers, characters, whatever, you need to use a special sequence.

To do this, we must combine the values we want to assign with the c function, which combines values into a *vector.*
...
The homework goes over this a lot. It can be dry and boring. But I want you to get a sort of *muscle memory* for how to do this
...
These are like dataframes but can only store either numbers or characters, not both

If you are doing fancy stats, they are helpful
