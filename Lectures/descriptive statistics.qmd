...
## a slighlty more complicated way
...
background-image: url(https://upload.wikimedia.org/wikipedia/commons/thumb/1/1a/Boxplot_vs_PDF.svg/250px-Boxplot_vs_PDF.svg.png) background-size: contain
...
background-image: url(https://upload.wikimedia.org/wikipedia/commons/thumb/8/8c/Standard_deviation_diagram.svg/1200px-Standard_deviation_diagram.svg.png) background-size: contain
...
background-image: url(https://s3.amazonaws.com/libapps/accounts/73082/images/Skeweness.jpg) background-size: contain
...
background-image: url(https://i.stack.imgur.com/KBQLN.jpg) background-size: contain
