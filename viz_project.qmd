...
>
> Rather than a normal handout/lab this one tells a story and has you learning ggplot while you do so. The reading here: <https://r4ds.had.co.nz/data-visualisation.html> can help youdoing this project. If you need more background on how ggplot works check out chpt 3 of <https://socviz.co/makeplot.html#makeplot> "Data Visualization"
>
...
#all_data %>% ggplot(aes(tail_length, fill=******************** )) + geom_histogram(color="#e9ecef", alpha=0.6, position = 'identity')  
```
